...
function Signup() {
  ...
  return (
    <motion.div
      ...
      className="min-h-screen bg-[#eef3f9] flex items-center justify-center px-4 py-6"
    >
      {" "}
      <div className="w-full max-w-5xl min-h-[85vh] bg-white rounded-[30px] shadow-2xl overflow-hidden grid lg:grid-cols-2">
        {" "}
        {/* LEFT SIDE */}
        <div className="hidden lg:flex bg-[#0B4EA2] relative flex-col justify-center items-center p-10 overflow-hidden">
          ...
          <div className="z-10 text-center mt-8">
            ...
            <p className="text-white/80 text-base leading-7 mt-6">
              Create your account and access secure digital libraries, smart
              management tools, and modern E-Book services.
            </p>
          </div>
        </div>
        {/* RIGHT SIDE */}
        <div className="flex items-center justify-center p-5 sm:p-8">
          ...
          <div className="w-full max-w-md">
            ...
            {/* TITLE */}
            <h2 className="text-3xl sm:text-4xl font-bold text-[#0B4EA2] mb-2">
              Signup
            </h2>

            <p className="text-gray-500 mb-7">Create your account</p>
      ...
      ${
        ...
        ${messageType === "success" ? "bg-green-500" : "bg-red-500"}`}
            ...
            <form onSubmit={handleSubmit} className="space-y-4 mt-5">
              ...
              {/* BUTTON */}
              <button className="w-full bg-orange-400 hover:bg-orange-500 text-white font-bold p-3 rounded-xl shadow-lg transition duration-300">
                Create Account
              </button>
            </form>
            ...
            <p className="text-center mt-6 text-gray-500">
              ...
              <Link to="/" className="text-[#0B4EA2] font-bold ml-2">
                Login
              </Link>
            </p>
          </div>
